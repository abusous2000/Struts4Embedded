...
- *Mosquito MQTT Broker* was used as the primary MQTT broker; other online MQTT brokers (i.e. Dashboard Broker) were tested and they worked as expected. Please inspect *[./conf/lwipopts.h](https://github.com/abusous2000/Struts4Embedded/blob/master/cfg/lwipopts.h#L87)* for MQTT broker's parameters.
