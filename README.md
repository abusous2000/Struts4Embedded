...
- see folder *./source/ESP8266WiFiModule* for Arduino sketch that runs the Web Service (web Server) on ESP8266. Please change your WiFi's SSID & password at the top of the sketch.
