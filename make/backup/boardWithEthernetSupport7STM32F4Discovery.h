...
/*
 *
MDIO	<=>		PA_2 --black        7th pin
MDC	<=>			PC_1---white        4th pin from top left
nINT/RETCLK	<=>	PA_1---Eggplant     6th pin
CRS	<=>			PA_7---Gray         9th pin
RX0	<=>			PC_4---blue         10th pin
RX1	<=>			PC_5-- green
TX_EN	<=>		PB_11--orange
TX0	<=>			PB_12--yellow
TX1	<=>			PB_13--Eggplant     7th ping from the bottom left
GND	<=>			GND
VCC	<=>			+3.3V
 *
 */
