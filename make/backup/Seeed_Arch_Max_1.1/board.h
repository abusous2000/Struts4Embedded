 ...
 * Ethernet PHY type.
 */
//#define BOARD_PHY_ADDRESS           0x01
#define BOARD_PHY_ID                MII_DP83848I_ID//MII_KS8721_ID
...
#define LINE_ARD_A1     PAL_LINE(GPIOA, 3U)
#define LINE_ARD_A2     PAL_LINE(GPIOA, 4U)
#define LINE_ARD_A3     PAL_LINE(GPIOA, 5U)
#define LINE_ARD_A4     PAL_LINE(GPIOA, 6U)
#define LINE_ARD_A5     PAL_LINE(GPIOB, 0U)

#define LINE_ARD_D0     PAL_LINE(GPIOD, 6U)
#define LINE_ARD_D1     PAL_LINE(GPIOD, 3U)
#define LINE_ARD_D2     PAL_LINE(GPIOD, 11U)
#define LINE_ARD_D3     PAL_LINE(GPIOD, 12U)
#define LINE_ARD_D4     PAL_LINE(GPIOD, 13U)
#define LINE_ARD_D5     PAL_LINE(GPIOA, 8U)
#define LINE_ARD_D6     PAL_LINE(GPIOB, 6U)
#define LINE_ARD_D7     PAL_LINE(GPIOB, 7U)

#define LINE_ARD_D8     PAL_LINE(GPIOB, 15U)
#define LINE_ARD_D9     PAL_LINE(GPIOB, 14U)
...
#define GPIOB_ARD_D7    7U
#define GPIOB_ARD_D8    15U
...
#define VAL_GPIOG_PUPDR             (PIN_PUPDR_PULLUP(GPIOG_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOG_ETH_RMII_TXEN) |\
                                     PIN_PUPDR_PULLUP(GPIOG_PIN12) |        \
                                     PIN_PUPDR_PULLUP(GPIOG_ETH_RMII_TXD0) |\
                                     PIN_PUPDR_PULLUP(GPIOG_ETH_RMII_TXD1) |\
