...
CHIBIOS  := ../../..
BOARD_NAME := stm32f407_blackboard4
...
USE_MAC := "no"
CHPRINTF_USE_FLOAT_VALUE := 1
DEBUG_TRACE_PRINT_VALUE  := 1
# Licensing files.
...
#UDEFS = -DFAULT_INFO_HOOK=_fault_info_hook -DBOARD_PHY_IDXX=MII_DP83848I_ID -DDEBUG_TRACE_PRINT=$(CHPRINTF_USE_FLOAT_VALUE) -DCHPRINTF_USE_FLOAT=$(CHPRINTF_USE_FLOAT_VALUE) -DINCLUDE_SEGGER_JLINK=$(INCLUDE_SEGGER_JLINK_VALUE)
